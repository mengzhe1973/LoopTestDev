...
public class DeviceListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 设定扫描按键响应
        Button scanButton = findViewById(R.id.search);
        ...
        // 初使化设备存储数组
        mPairedDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.layout_ble);
        mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.layout_ble);
